      ...
      >
        ...
        >
          ...
          </h4>
          {
            isGroup
            ?  <Avatar
                 {...stringAvatar(roomData?.name, ' ', '#9c27b0')}
                 onClick={handleClick}
        ...
        >
          {
            messages?.length !== 0
              ...
              : <p className={classes.empty}>Nenhuma mensagem enviada até agora. <br/>Seja o primeiro!</p>
          }
        </Grid>
      </Grid>
      <Formik
        ...
        {({
          ...
          <form
            ...
            >
              ...
              <Grid item width='100%'>
                <Button color="secondary" type='submit' variant="contained" fullWidth>Enviar <SendIcon style={{marginLeft: '10px'}} /></Button>
              </Grid>
            </Grid>
          </form>
        )}
